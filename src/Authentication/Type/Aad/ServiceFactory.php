...
class ServiceFactory
{
    ...
    {
        $config = $this->config->get('auth.aad');
        ...
        /** @var Url $callbackUrl */
        $callbackUrl = $this->urlResolver->resolve(['/ccm/system/authentication/oauth2/aad/callback/']);
        ...
        return $factory->createService('aad', $credentials, $storage, [
            AadService::SCOPE_OPENID
            ,
        ], $baseApiUrl);
    }
